...
if (option && typeof option === "object") {
    ...
    /*
    var echartarea = echarts.init(document.getElementById('echart_line'))     
    var xAxisdata=[]
    var seriesdata=[]
    ...
    $.ajax({        
        type: "get",
        async: true,
        //url: "http://10.48.6.219:9002/week-line-spark/stock_hs_k_data",
        url: "echart_01.json",
        dataType: "json",
        success: function (result) {
            ...
            if (result) {
                for (var i = 0; i < result.length; i++) {
                    ...
                    seriesdata.push(result[i].money);
                }
